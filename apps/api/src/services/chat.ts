...
export async function sendMessage(
  ...
  args: {
    ...
    type?: 'text' | 'image' | 'voice' | 'media_locked' | 'order_offer' | 'schedule_offer' | 'gift_hint' | 'chat_paywall' | 'shop_info' | 'customer_location' | 'gift' | 'order_card';
    mediaRef?: string;
    isAiAlter?: boolean;
    isEncrypted?: boolean;
  },
  ...
  if (!args.isEncrypted && args.type !== 'image' && args.type !== 'voice' && args.type !== 'order_offer' && args.type !== 'schedule_offer' && args.type !== 'gift_hint' && args.type !== 'chat_paywall' && args.type !== 'shop_info' && args.type !== 'customer_location' && args.type !== 'gift' && args.type !== 'order_card') {
    try {
  ...
  if (!args.isEncrypted && args.type !== 'order_offer' && args.type !== 'schedule_offer' && args.type !== 'gift_hint' && args.type !== 'chat_paywall' && args.type !== 'shop_info' && args.type !== 'customer_location' && args.type !== 'voice' && args.type !== 'gift' && args.type !== 'order_card') {
    fireAndForget(
